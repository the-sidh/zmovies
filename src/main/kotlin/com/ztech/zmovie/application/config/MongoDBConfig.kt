package com.ztech.zmovie.application.config
...
fun mongoDatabase(
    ...
    return mongoClientConnection(connectionString, getMongoCredentials(user, password, databaseName), codecRegistries)
